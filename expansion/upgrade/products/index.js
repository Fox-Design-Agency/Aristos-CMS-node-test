...
const adminProductCategory = fs.readJSONSync(
...
const adminProductCategories = require(adminProductCategory);
const adminProductStats = require("./routes/admin_product_stats");

module.exports = app => {
  /* set global cart on session */
  // move to a config type file???
  ...
  app.use("/admin/products/stats", adminProductStats);
